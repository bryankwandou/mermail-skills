...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-countersig
```
...
| `mermail-countersig` | Prove a new or changed Solana or Base payout wallet with signed memos before any payment |
